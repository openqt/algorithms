...
Example 1:
	...
	And at time point 4, Teemo attacks Ashe again,
	and causes Ashe to be in poisoned status for another 2 seconds.
...
func main() {
	...
	fmt.Println(findPoisonedDuration([]int{}, 100000) == 0)
}
