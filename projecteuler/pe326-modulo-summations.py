...
Let $a_n$ be a sequence recursively defined by:$\quad a_1=1,\quad\displaystyle
a_n=\biggl(\sum_{k=1}^{n-1}k\cdot a_k\biggr)\bmod n$.
...
\quad\htmltext{and}\quad\biggl(\sum_{i=p}^qa_i\biggr)\bmod M=0 $$
