...
Peter moves in a hallway with N+1 doors consecutively numbered from 0 through
N. All doors are initially closed. Peter starts in front of door 0, and
...
possible actions. You are given that F(5) = 1, F(100) = 27, F(1000) = 233 and
F(106) = 112168.
