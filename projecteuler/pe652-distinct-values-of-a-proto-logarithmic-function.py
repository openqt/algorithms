...
Consider the values of $\log_2(8)$, $\text{log}_4(64)$ and $\text{log}_3(27)$.
All three are equal to $3$.

Generally, the function $f(m,n)=\text{log}_m(n)$ over integers $m,n \ge 2$ has
the property that  
...
We call a function $g(m,n)$ over integers $m,n \ge 2$ _proto-logarithmic_ if
...
$\text{log}_m(n)$ is _proto-logarithmic_.  
