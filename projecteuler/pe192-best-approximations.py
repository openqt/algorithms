...
A _best approximation_ to  x for the _denominator bound_ d is a rational
number r/s _in reduced form_ , with s ≤ d, such that any rational number which
is closer to x than r/s has a denominator larger than d:
