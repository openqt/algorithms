...
Alice plays the following game, she starts with a list of integers $L$ and on
each step she can either:
...
An integer $n>1$ is said to be _creative_ if for any integer $m >1$ Alice can
