...
We shall say that M( _n_ , _d_ ) represents the maximum number of repeated
digits for an _n_ -digit prime where _d_ is the repeated digit, N( _n_ , _d_ )
represents the number of such primes, and S( _n_ , _d_ ) represents the sum of
these primes.
