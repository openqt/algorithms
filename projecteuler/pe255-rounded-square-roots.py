...
We define the _rounded-square-root_ of a positive integer  n as the square
...
$$x_1 = \Biggl\lfloor{\dfrac{70 + \lceil{4321 / 70}\rceil}{2}}\Biggr\rfloor =
66\\\ x_2 = \Biggl\lfloor{\dfrac{66 + \lceil{4321 /
66}\rceil}{2}}\Biggr\rfloor = 66$$ Since $x_2 = x_1$, we stop here.  
