...
answer will immediately lead us to find the hidden number (at a total cost =
2).
...
Let our second question be " **6** ". If the hidden number is still higher
than 6, we will need a third question in order to discriminate between 7 and
8.  
