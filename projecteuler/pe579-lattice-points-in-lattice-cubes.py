...
Let C( n) be the number of different lattice cubes in which the coordinates of
...
(5, 3, 3) contains only 40 lattice points (20 points on the surface and 20
...
cubes in which the coordinates of all vertices range between (and including) 0
and n.
